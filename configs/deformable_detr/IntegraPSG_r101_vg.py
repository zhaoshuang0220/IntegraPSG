...
model = dict(
    ...
    bbox_head=dict(
        ...
        relation_decoder=dict(
            ...
            transformerlayers=dict(
                type="BaseTransformerLayer",
                norm_cfg=dict(type="RMSNorm", eps=1e-6),
                attn_cfgs=dict(
                    type="MultiheadAttention",
                    embed_dims=256,
                    num_heads=8,
        ...
        rel_cls_loss=dict(
            ...
            loss_weight=0.1,
            reduction="mean",
            class_weight="/home/jhwang/pretrain/r_label_weight_vg2.pt",
            gamma=2.0,
        ),
...
# learning policy
lr_config = dict(policy="step", gamma=0.1, step=[6, 10])
runner = dict(type="EpochBasedRunner", max_epochs=12)

project_name = "vg_3090"
expt_name = "vg_focallossg1"
...
# load_from = "/mnt/lustre/bli/wangjh/PSG-mix/work_dirs/vg_od_ddetr2/epoch_31.pth"
