_base_ = ["../_base_/datasets/psg2.py", "../_base_/custom_runtime.py"]  # 指向含深度图的psg2.py
...
model = dict(
    ...
    bbox_head=dict(
        ...
        subobj_cls_loss=dict(
            ...
            loss_weight=4.0,
            reduction="mean",
            class_weight=[1.0] * (num_object_classes + 1),
        ),
...
train_pipeline = [
    ...
    dict(type="LoadDepthImageFromFile", depth_dir="data/coco/depth_train2017"),
    dict(
    ...
    dict(type="Collect", keys=["img", "depth", "gt_bboxes", "gt_labels", "gt_rels", "gt_masks"]),
]
...
test_pipeline = [
    dict(type="LoadImageFromFile"),
    dict(type="LoadDepthImageFromFile", depth_dir="data/coco/depth_val2017"),
...
lr_config = dict(policy="step", gamma=0.1,step=[5,10]
                 )
...
load_from = "pretrain/mask2former_r50_lsj_8x2_50e_coco-panoptic_20220326_224516-11a44721_renamed.pth"
gpu_ids = [0]
