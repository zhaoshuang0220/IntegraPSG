...
custom_imports = dict(
    imports=[
        "IntegraPSG.models.frameworks.psgtr",
        "IntegraPSG.models.losses.seg_losses",
        "IntegraPSG.models.frameworks.dual_transformer",
        "IntegraPSG.models.relation_heads.psgformer_head",
        "IntegraPSG.datasets",
        "IntegraPSG.datasets.pipelines.loading",
        "IntegraPSG.datasets.pipelines.rel_randomcrop",
        "IntegraPSG.models.relation_heads.approaches.matcher",
        "IntegraPSG.utils",
    ],
...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            "backbone": dict(lr_mult=0.1, decay_mult=0.1),
            "transformer_decoder": dict(lr_mult=0.1, decay_mult=0.1),
            "pixel_decoder": dict(lr_mult=0.1, decay_mult=0.1),
            "decoder_input_projs": dict(lr_mult=0.1, decay_mult=0.1),
        },
        norm_decay_mult=0.0,
    ),
)
...
project_name = "ATM"
expt_name = "3090_baseline"
work_dir = f"./work_dirs/{expt_name}"
checkpoint_config = dict(by_epoch=False, interval=500, max_keep_ckpts=15)
...
#load_from = "/home/jhwang/PSG-mix/work_dirs/3090_baseline/epoch_1.pth"
